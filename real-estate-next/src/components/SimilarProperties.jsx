...
import { faLongArrowAltRight, faMapLocationDot } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="row d-flex justify-content-between">
        {properties.map((property) => (
          <section key={property.id} className="col-md-4 col-sm-12 list-studio mb-4">
            ...
            <Image src={studioImage1} alt="studio-1" className="card-img-top" />
              <div className="card-body">
                <div className="card-title">
                  <h6>{property.title}</h6>
                </div>
                <div className="card-text">
                  <p><FontAwesomeIcon icon={faMapLocationDot} /> {property.location}</p>
                  <p>
                ...
                <div className="card-footer d-flex justify-content-between align-items-center">
                  ...
                  <span><FontAwesomeIcon icon={faLongArrowAltRight} /> compare</span>
                  <Link href="/Studio">
