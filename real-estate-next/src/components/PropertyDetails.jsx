...
import { faHeart, faLeftRight, faPrint, faShareNodes, faMapLocationDot,faHouse, faFilter,faBed, faRestroom} from "@fortawesome/free-solid-svg-icons";
  ...
  return (
        <div className="property-details shadow p-4 mt-3">
          ...
          <div className="d-flex justify-content-between ">
            <div className="d-flex flex-column">
              <p className="text-color">
                <FontAwesomeIcon icon={faMapLocationDot} /> 102 102 Ingraham St, Brooklyn, NY 11237
              </p>
            ...
            <div>
              <button className="iconbuttons m-2">
                <FontAwesomeIcon icon={faHeart} className='details-icon' />
              </button>
              <button className="iconbuttons m-2">
                <FontAwesomeIcon icon={faLeftRight} className='details-icon' />
              </button>
              <button className="iconbuttons m-2">
                <FontAwesomeIcon icon={faPrint} className='details-icon' />
              </button>
              <button className="iconbuttons m-2">
                <FontAwesomeIcon icon={faShareNodes} className='details-icon' />
              </button>
            </div>
          </div>
          {/* Group 1 Icons */}
          <div className="d-flex flex-wrap">
            <div className="d-flex col-sm-6 col-md-3 mb-2">
              <button className="button-card m-1">
                <FontAwesomeIcon icon={faHouse} className='more-icon' />
              </button>
              <p className="m-2">
            ...
            <div className="d-flex col-sm-6 col-md-3 mb-2">
              <button className="button-card m-1">
                <FontAwesomeIcon icon={faFilter} className='more-icon' />
              </button>
              <p className="m-2">
            ...
            <div className="d-flex col-sm-6 col-md-3 mb-2">
              <button className="button-card m-1">
                <FontAwesomeIcon icon={faBed} className="more-icon" />
              </button>
              <p className="m-2">
          ...
          <div className="d-flex flex-wrap">
            <div className="d-flex col-sm-6 col-md-3 mb-2">
              <button className="button-card m-1">
                <FontAwesomeIcon icon={faRestroom} className='more-icon' />
              </button>
              <p className="m-2">
